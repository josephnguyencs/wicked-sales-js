...
11	2020-10-02 00:17:08.403549+00
\.
...
24	11	ss	ss	ds	2020-10-02 00:18:36.998832+00
\.
...
SELECT pg_catalog.setval('public."cartItems_cartItemId_seq"', 151, true);
...
SELECT pg_catalog.setval('public."order_orderId_seq"', 24, true);
